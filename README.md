...
The easiest way to use one of the shapes from **Awesome Shapes** is to install the NPM package and import the particular loader to use it.
...
Read the complete in detail documentation on the [project website](https://awesomeshapes.netlify.app/).
